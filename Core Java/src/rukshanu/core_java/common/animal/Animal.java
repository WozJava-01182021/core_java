...
// Static Variables first
	...
	protected int BIRTH_WEIGHT = 50;
	protected int ADULT_FEMALE_MIN_WEIGHT = 50;
	protected int ADULT_MALE_MIN_WEIGHT = 50;
	protected int ADULT_FEMALE_MAX_WEIGHT = 50;
	protected int ADULT_MALE_MAX_WEIGHT = 50;
...
//************************METHOD SECTION *****************************
	...
	public void setRandomWeightByAge(int femaleMinWeight, int femaleMaxWeight, int maleMinWeight, int maleMaxWeight, int birthWeight) {
