...
public class Primitives {
	...
	public void inClassWork() {
		...
		long numberOfStarsInMilkyWay = 200000000000L; // UPPERCASE L DUDE
		// integer literal default is an int (32 bits)
		System.out.println("byte = " + w + ",  short = " + x + ",  int = " + y + ",  long = " + z);
		// STUDENT EXERCISE: remove the L, change it to lower case, what happens? => would still work

		// floating point literals
		double d = 123456789.123456789;
		float f = 123456789.123456789F;
		System.out.println("double = " + d + ",  float f = " + f );
		// STUDENT EXERCISE: remove the F, change it to f, what happens? => would still work
